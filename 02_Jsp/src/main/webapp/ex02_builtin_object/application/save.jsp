...
<body>
	...
	<%
		...
		String realPath = application.getRealPath("storage");	// SevletContext 객체 == application 내장 객체
	...
	<script>
		...
		if(isCreated) {
			...
			location.href = '<%=request.getContextPath()%>/ex2_builtin_object/application/write_form.jsp';
		} else {
